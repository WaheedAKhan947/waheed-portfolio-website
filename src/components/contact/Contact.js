...
function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_5nyx9mi', 'template_p2unkrh', form.current, 'user_13JyhTEwPZCewxm-M')
  ...
  return <div className="contact" id="contact">
    ...
    <div className="contact_container">
      ...
      <form ref={form} onsubmit={sendEmail} className="contact_form">
        ...
        <button className="btn btn-primary w-50" type="submit">Send Messege</button>
      </form>
    </div>
  </div>;
}
